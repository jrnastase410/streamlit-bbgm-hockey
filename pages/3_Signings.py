...
def main():
    ...
    for i in range(num_options):
        ...
        num_years = st.slider('Enter the number of years', min_value=1, max_value=num_options, step=1, key=f'{i}years')

        # Get salary from the user
        salary = st.slider('Enter the salary', min_value=0.0, max_value=14.0,
